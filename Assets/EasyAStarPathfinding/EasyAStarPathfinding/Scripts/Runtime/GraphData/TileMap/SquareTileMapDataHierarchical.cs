...
{
    [Serializable]
    public class SquareTileMapDataHierarchical : ITileMapData, IHierarchicalGraphData<Tile>
    {
        ...
        public Tile GetNodeForLevel(int inputLevel, Tile inputNode, int targetLevel)
        {
            throw new NotImplementedException();
        }

        public void ConfigCurrentLevel(int curLevel)
        {
            throw new NotImplementedException();
        }
    }
